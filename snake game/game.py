...
back=pygame.image.load('backround.jpg')
back=pygame.transform.scale(back,(900,600)).convert_alpha()
start=pygame.image.load('start.jpg')
start=pygame.transform.scale(start,(900,600)).convert_alpha()
...
def welcome():
    ...
    while running:
        ...
        win.blit(start,(0,0))
        text_display(("PRESS ENTER TO START"),(255,0,0),170,200)
...
def gameloop():
    ...
    while running:
        if gameover:
            ...
            pygame.draw.rect(win,(200,50,200),(fx,fy,size,size))
